...
\\
\textit{column} is the column of the current position
\\
...
\textit{board} is the $n \times n$ square matrix representing the sudoku puzzle grid 
\\ 
\State initialise temp = array of length 2
...
\\ 
	\State initialise row,col; 
	\State initialise temp = openPosition();	
...
\todo{do the theoretical analysis}
